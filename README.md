...
1. Compile the smart contract successfully.

![](Execution_Results/compiled.jpg)

2. In the Remix IDE, navigate to the “Deploy & Run Transactions” pane, and then “Remix VM (London)” is selected as the environment.

3. Click the Deploy button to deploy the smart contract. Contract was deployed successfully.

![](Execution_Results/deployed.jpg)
...
Following dummy accounts addresses were used:

    > Dummy account1 address: 0x0c0669Cd5e60a6F4b8ce437E4a4A007093D368Cb
    > Dummy account2 address: 0x7A1f3dFAa0a4a19844B606CD6e91d693083B12c0

![](Execution_Results/setAccounts.jpg)

2. Test the deposit functionality 

    * Transaction 1: Send 1 ether as wei.

![](Execution_Results/Transaction1.jpg)  

    * Transaction 2: Send 10 ether as wei.

![](Execution_Results/Transaction2.jpg)  

    * Transaction 3: Send 5 ether.

![](Execution_Results/Transaction3.jpg)  
...
![](Execution_Results/withdraw1.jpg)  

    * Transaction 2: Withdrawing 10 ether into `accountTwo`.

![](Execution_Results/withdraw2.jpg)  
